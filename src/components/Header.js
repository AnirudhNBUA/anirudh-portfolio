        ...
        <div className="hidden md:flex items-center gap-1 text-sm font-medium text-gray-400">
          ...
          <div className="ml-6">
            <a
              ...
              className="px-6 py-2.5 rounded-full bg-white text-black font-bold hover:bg-gray-200 transition-all btn-glow shadow-[0_0_15px_rgba(255,255,255,0.2)] hover:shadow-[0_0_25px_rgba(255,255,255,0.35)]"
            >
              Hire Me
            </a>
          </div>
