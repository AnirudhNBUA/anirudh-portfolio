    ...
    <div className="max-w-6xl mx-auto">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
        ...
        >
          ...
          <div className="glass p-10 rounded-3xl border border-white/5 hover:border-sky-500/20 transition-all duration-500 group mt-6">
        ...
        >
          ...
          <div className="space-y-4 mt-6">
            {certifications.map((cert, i) => (
              <motion.div
                key={i}
                className={`glass p-6 rounded-2xl flex items-center gap-5 border border-white/5 ${cert.border} transition-all duration-300 group cursor-default`}
